(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,36537,e=>{"use strict";var a=e.i(43476),i=e.i(71645),n=e.i(47481),t=e.i(74324),o=e.i(91803);e.s(["default",0,function(){let{homeData:e}=(0,t.useContent)(),s=e||o.default,[r,l]=(0,i.useState)(!1),c=(0,i.useRef)(null);return(0,i.useEffect)(()=>{let e=new IntersectionObserver(([e])=>{l(e.isIntersecting)},{threshold:.1,rootMargin:"0px 0px -50% 0px"});return c.current&&e.observe(c.current),()=>{c.current&&e.unobserve(c.current)}},[]),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{ref:c,className:"parallax-spacer"}),(0,a.jsx)("section",{className:`parallax-section ${r?"visible":""}`,children:(0,a.jsx)("div",{className:"parallax-content",children:(0,a.jsx)(n.default,{text:s.parallax.text,className:"parallax-text",tag:"h1",delay:80,duration:1.2,from:{opacity:0,y:60,rotateX:-45,scale:.8},to:{opacity:1,y:0,rotateX:0,scale:1},trigger:r})})})]})}])},46812,e=>{"use strict";var a=e.i(43476),i=e.i(71645),n=e.i(22016),t=e.i(74324),o=e.i(91803);e.s(["default",0,function(){let{homeData:e}=(0,t.useContent)(),s=e||o.default,[r,l]=(0,i.useState)(null),c=s.faq.questions.map((e,a)=>({id:a+1,question:e.question,answer:e.answer}));return(0,a.jsx)("section",{className:"faq-section",children:(0,a.jsxs)("div",{className:"faq-container",children:[(0,a.jsxs)("div",{className:"faq-header","data-aos":"fade-up",children:[(0,a.jsx)("div",{className:"faq-badge",children:s.faq.badge}),(0,a.jsx)("h2",{className:"faq-title",children:s.faq.title}),(0,a.jsx)("p",{className:"faq-subtitle",children:s.faq.subtitle})]}),(0,a.jsx)("div",{className:"faq-list","data-aos":"fade-up","data-aos-delay":"200",children:c.map((e,i)=>(0,a.jsxs)("div",{className:`faq-item ${r===e.id?"open":""}`,children:[(0,a.jsxs)("button",{className:"faq-question",onClick:()=>{var a;l(r===(a=e.id)?null:a)},"aria-expanded":r===e.id,children:[(0,a.jsx)("span",{className:"question-text",children:e.question}),(0,a.jsx)("span",{className:"faq-icon",children:r===e.id?"−":"+"})]}),(0,a.jsx)("div",{className:"faq-answer",children:(0,a.jsx)("div",{className:"answer-content",children:(0,a.jsx)("p",{children:e.answer})})})]},e.id))}),(0,a.jsx)("div",{className:"faq-footer","data-aos":"fade-up","data-aos-delay":"800",children:(0,a.jsxs)("div",{className:"faq-cta",children:[(0,a.jsx)("h3",{children:s.faq.ctaSection.title}),(0,a.jsx)("p",{children:s.faq.ctaSection.description}),(0,a.jsx)(n.default,{href:"/contact",className:"faq-contact-btn",children:s.faq.ctaSection.button})]})})]})})}])},10425,e=>{"use strict";var a=e.i(91803);let i=[{id:1,title:"The Complete Guide to Creating a Safe Home Environment for Seniors",category:"Safety",date:"January 15, 2024",readTime:"8 min read",excerpt:"Learn essential home modifications and safety tips to prevent falls and accidents while maintaining independence for elderly family members.",image:a.default.images.blog.articleImages[0],content:`Creating a safe home environment for seniors is one of the most important steps you can take to ensure their well-being and independence. As we age, our physical abilities may change, making certain areas of the home potentially hazardous. However, with proper planning and modifications, you can create a space that promotes both safety and comfort.
...
Creating a safe home environment is an ongoing process, not a one-time project. By taking a proactive approach and making gradual improvements, you can help your loved one maintain their independence while staying safe and comfortable in their own home.`,tags:["Home Safety","Fall Prevention","Independence","Modifications"],author:{name:"Dr. Sarah Johnson",title:"Occupational Therapist & Home Safety Specialist",image:a.default.images.blog.profileImages[0]}},{id:2,title:"Understanding Alzheimer's Disease: A Comprehensive Family Guide",category:"Health & Wellness",date:"January 12, 2024",readTime:"12 min read",excerpt:"A detailed guide to understanding Alzheimer's disease, its stages, symptoms, and how families can provide the best support and care for their loved ones.",image:a.default.images.blog.articleImages[1],content:`Alzheimer's disease affects millions of families worldwide, yet many people don't fully understand what it is or how it progresses. This comprehensive guide will help you understand the disease and learn how to provide the best possible care and support for your loved one.
...
Every person's journey with Alzheimer's is unique, and there's no single right way to provide care. Trust your instincts, seek professional guidance when needed, and remember that providing love and support in whatever form possible is what matters most.`,tags:["Alzheimer's","Dementia Care","Family Support","Caregiver Resources"],author:{name:"Dr. Michael Chen",title:"Neurologist & Dementia Care Specialist",image:a.default.images.blog.profileImages[1]}},{id:3,title:"The Power of Companion Care: Combating Loneliness in Seniors",category:"Mental Health",date:"January 10, 2024",readTime:"6 min read",excerpt:"Discover how companion care services can significantly improve quality of life, provide emotional support, and reduce social isolation among elderly adults.",image:a.default.images.blog.articleImages[2],content:`Loneliness among seniors has reached epidemic proportions, with serious consequences for both physical and mental health. Studies show that social isolation can be as harmful to health as smoking 15 cigarettes a day. Companion care offers a powerful solution to this growing problem, providing not just practical support but meaningful human connection.
...
If you're caring for a senior who is struggling with nutrition, don't hesitate to seek help from healthcare professionals, registered dietitians, or community resources. Good nutrition is too important to tackle alone, and there are many resources available to help ensure your loved one gets the nourishment they need to thrive.`,tags:["Nutrition","Healthy Eating","Meal Planning","Senior Health"],author:{name:"Jennifer Adams, RD",title:"Registered Dietitian & Nutrition Specialist",image:a.default.images.blog.profileImages[3]}},{id:5,title:"Respite Care: Essential Support for Family Caregivers",category:"Family Support",date:"January 5, 2024",readTime:"5 min read",excerpt:"Understanding the importance of respite care and how it can help prevent caregiver burnout while ensuring continuous quality care for your loved one.",image:a.default.images.blog.articleImages[4],content:`Caring for an aging or disabled family member can be one of the most rewarding experiences in life, but it can also be physically and emotionally exhausting. Family caregivers often put their own needs aside to focus on their loved one's care, leading to stress, burnout, and health problems. Respite care offers a vital solution, providing temporary relief for caregivers while ensuring their loved one continues to receive quality care.
...
If you're a family caregiver, don't wait until you're overwhelmed to seek respite care. Regular breaks, even short ones, can help you maintain your physical and emotional health while providing the best possible care for your loved one. You deserve support, and your loved one benefits when you're at your best.`,tags:["Respite Care","Caregiver Support","Family Caregiving","Burnout Prevention"],author:{name:"Maria Santos",title:"Family Care Coordinator & Support Specialist",image:a.default.images.blog.profileImages[4]}},{id:6,title:"Exercise and Physical Activity for Seniors: Staying Active and Independent",category:"Health & Wellness",date:"January 3, 2024",readTime:"9 min read",excerpt:"Discover safe and effective exercise strategies for seniors that can improve strength, balance, flexibility, and overall health while maintaining independence.",image:a.default.images.blog.articleImages[5],content:`Regular physical activity is one of the most important things seniors can do to maintain their health, independence, and quality of life. Despite common misconceptions, age is not a barrier to exercise – in fact, staying active becomes even more crucial as we get older. The right exercise program can help prevent chronic diseases, improve mental health, maintain cognitive function, and reduce the risk of falls.
...
Exercise is truly one of the best medicines available for healthy aging. With proper guidance, a gradual approach, and attention to safety, seniors can enjoy the many benefits of staying active while reducing their risk of chronic disease and maintaining their independence.`,tags:["Exercise","Physical Activity","Fall Prevention","Healthy Aging"],author:{name:"Dr. Robert Kim",title:"Geriatrician & Exercise Medicine Specialist",image:a.default.images.blog.profileImages[5]}},{id:8,title:"Technology for Seniors: Staying Connected in the Digital Age",category:"Care Tips",date:"December 25, 2023",readTime:"8 min read",excerpt:"Explore how modern technology can enhance independence, safety, and social connection for seniors, with practical tips for getting started.",image:a.default.images.blog.articleImages[3],content:`Technology has revolutionized how we communicate, access information, and manage our daily lives. For seniors, embracing technology can open up new possibilities for staying connected with family and friends, accessing healthcare services, managing home safety, and maintaining independence. While the digital world can seem overwhelming at first, the right approach can help seniors harness technology's benefits while avoiding its pitfalls.
