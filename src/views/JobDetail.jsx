                ...
                <div className="job-apply-container">
                    <div className="job-apply-content" data-aos="fade-up">
                        ...
                        <p className="apply-note">
                            ...
                            <a href={`mailto:${process.env.NEXT_PUBLIC_ADMIN_EMAIL || 'info@example.com'}`} className="email-link">
                                {process.env.NEXT_PUBLIC_ADMIN_EMAIL || 'info@example.com'}
                            </a>{' '}
                            or call{' '}
