    ...
    for (const field of fileFields) {
      ...
      if (file && file instanceof File) {
        try {
          ...
          console.log(`✓ Attachment prepared: ${attachment.name} (${attachment.contentType})`);
        } catch (e) {
          console.error(`✗ Attachment encode failed for ${field.key}:`, e);
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="800" style="max-width:800px;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
          <tr>
            <td style="background:#1a1a1a;color:#ffffff;padding:24px 20px;text-align:center;">
              <h1 style="margin:0 0 6px 0;font-size:24px;color:#ffffff;">📝 New Employment Application</h1>
          ...
          <tr>
            <td style="background:#f8f9fa;padding:24px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:16px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e9ecef;">
                <tr>
                  <td style="font-weight:bold;color:#ffffff;background:#1a1a1a;padding:12px 15px;font-size:14px;">👤 Applicant Information</td>
                </tr>
                <tr>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:16px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e9ecef;">
                <tr>
                  <td style="font-weight:bold;color:#ffffff;background:#1a1a1a;padding:12px 15px;font-size:14px;">🎓 Education & Training</td>
                </tr>
                <tr>
                  <td style="padding:16px;line-height:1.6;color:#1a1a1a;">
                    <div><strong>High School:</strong> ${form.educationHighSchool ? '✅ Yes' : '❌ No'}</div>
                    <div><strong>College:</strong> ${form.educationCollege ? '✅ Yes' : '❌ No'}</div>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:16px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e9ecef;">
                <tr>
                  <td style="font-weight:bold;color:#ffffff;background:#1a1a1a;padding:12px 15px;font-size:14px;">💼 Employment History</td>
                </tr>
                <tr>
                  <td style="padding:16px;line-height:1.6;color:#1a1a1a;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:16px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e9ecef;">
                <tr>
                  <td style="font-weight:bold;color:#ffffff;background:#1a1a1a;padding:12px 15px;font-size:14px;">📇 Professional References</td>
                </tr>
                <tr>
                  <td style="padding:16px;line-height:1.6;color:#1a1a1a;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:10px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e9ecef;">
                <tr>
                  <td style="font-weight:bold;color:#ffffff;background:#1a1a1a;padding:12px 15px;font-size:14px;">ℹ️ Additional Information</td>
                </tr>
                <tr>
                  <td style="padding:16px;line-height:1.6;color:#1a1a1a;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:10px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e9ecef;">
                <tr>
                  <td style="font-weight:bold;color:#ffffff;background:#1a1a1a;padding:12px 15px;font-size:14px;">📎 Attached Files</td>
                </tr>
                <tr>
                  <td style="padding:16px;line-height:1.6;color:#1a1a1a;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:10px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e9ecef;">
                <tr>
                  <td style="font-weight:bold;color:#ffffff;background:#1a1a1a;padding:12px 15px;font-size:14px;">📅 Submission</td>
                </tr>
                <tr>
                  <td style="padding:16px;line-height:1.6;color:#1a1a1a;">
